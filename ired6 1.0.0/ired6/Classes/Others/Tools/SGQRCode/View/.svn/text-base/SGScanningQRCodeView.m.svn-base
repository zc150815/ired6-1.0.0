...
- (void)setupScanningQRCodeEdging {
    ...
    CGFloat scanContentViewW = self.frame.size.width/2;
    CGFloat scanContentViewH = scanContentViewW;
    CGFloat scanContentViewX = (self.frame.size.width - scanContentViewW)/2;
    CGFloat scanContentViewY = 50;
...
#pragma mark - - - 扫描外部View的创建
    ...
    CGFloat left_ViewW = scanContentViewX;
    ...
    CGFloat right_ViewW = scanContentViewX;
    ...
    promptLabel.font = [UIFont boldSystemFontOfSize:10.0];
    ...
    light_button.titleLabel.font = [UIFont systemFontOfSize:15];
